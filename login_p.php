...
if (isset($_POST['nik']) && isset($_POST['password'])) {
    ...
    $query = "SELECT * FROM tb_pasien WHERE nik = '$nik' AND password = '$password'";
...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <h1 class="text-center my-5" style="font-family: 'Wix Madefor Text', sans-serif;">Login User </h1><br>
                ...
                <form method="POST" action="" class="login-form" >
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nik" id="nik" placeholder="Enter NIK">
                    </div>
                    <div class="form-group">
