...
if (isset($_POST['kode']) && isset($_POST['password'])) {
    ...
    $query = "SELECT * FROM tb_apoteker WHERE kode_apoteker = ? AND password = ?";
    $stmt = mysqli_prepare($db, $query);
    mysqli_stmt_bind_param($stmt, "ss", $kode, $password);
...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <h1 class="text-center my-5" style="font-family: 'Wix Madefor Text', sans-serif;">Login Apoteker </h1><br>
                ...
                <form method="POST" action="" class="login-form" >
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode" id="kode" placeholder="Enter kode Apoteker">
                    </div>
                    <div class="form-group">
